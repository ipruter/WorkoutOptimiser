...
public class FridayExercisesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_friday_exercises);
        ...
        Spinner spinner = (Spinner) findViewById(R.id.nameET_friday);
        ...
        Button save = (Button)findViewById(R.id.save_friday);
        ...
        ExerciseAdapter fridayAdapter = new ExerciseAdapter(this, fridayExercises);
        // Attach the adapter to a ListView
        ListView fridayLV = (ListView) findViewById(R.id.fridayLV);
        fridayLV.setAdapter(fridayAdapter);
        EditText setsET = (EditText) findViewById(R.id.setsET_friday);
        EditText repsET = (EditText) findViewById(R.id.repsET_friday);
        EditText weightET = (EditText) findViewById(R.id.weightET_friday);
        Button add = (Button)findViewById(R.id.friday_add);
        // Activates method on yes button click
        add.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                fridayExercises.add(exercise);
                fridayAdapter.notifyDataSetChanged();
            }
        });
        // Deletes exercises that user holds down on
        fridayLV.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                final int itemToDelete = i;
                // To delete the data from the App
                new AlertDialog.Builder(FridayExercisesActivity.this)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                fridayExercises.remove(itemToDelete);
                                fridayAdapter.notifyDataSetChanged();
                            }
    ...
    // Saves Friday's exercises
    public void save(String id){
        SharedPreferences pref = getSharedPreferences(id+"friday", MODE_PRIVATE);
        SharedPreferences.Editor editor = pref.edit();
        Gson gson = new Gson();
        String jsonSun = gson.toJson(fridayExercises); // Converts array to json file
        editor.putString(id+"listFri", jsonSun); // Saves json file
        editor.apply();
    }
    
    // Loads Friday's exercises
    public void load(String id){
        SharedPreferences pref = getSharedPreferences(id+"friday", MODE_PRIVATE);
        Gson gson = new Gson();
        String json = pref.getString(id+"listFri", null); // Retrieves json file from storage
        ...
        else{fridayExercises = gson.fromJson(json, type);}
    }
    ...
    public void loadSpinnerNames(){
        ...
        Gson gson = new Gson();
        String json = pref.getString("spinnerNamesList", null); // Loads json file from storage
        Type type = new TypeToken<ArrayList<String>>() {}.getType(); // Creates type token
        // Creates new array if json file is null
        if (json == null){
            exerciseNames = new ArrayList<String>();
        }
        // Converts json file to array otherwise
    ...
    public void loadExerciseTypes(){
        ...
        // Converts json file into array otherwise
        else{exerciseTypesList = gson.fromJson(json, type);}
