...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(exerciseTypesList.isEmpty()) {
            ...
            exerciseTypesList.add(new ExerciseTypes("Bicep curls", none, false));
            exerciseNames.add("Bicep curls");
            exerciseTypesList.add(new ExerciseTypes("Calf raises", none, false));
            ...
            exerciseTypesList.add(new ExerciseTypes("Shrugs", none, false));
            exerciseNames.add("Shrugs");
