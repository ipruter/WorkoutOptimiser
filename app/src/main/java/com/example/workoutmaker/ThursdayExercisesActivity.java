...
public class ThursdayExercisesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thursday_exercises);
        ...
        Spinner spinner = (Spinner) findViewById(R.id.nameET_thursday);
        ...
        Button save = (Button)findViewById(R.id.save_thursday);
        ...
        ExerciseAdapter thursdayAdapter = new ExerciseAdapter(this, thursdayExercises);
        // Attach the adapter to a ListView
        ListView thursdayLV = (ListView) findViewById(R.id.thursdayLV);
        thursdayLV.setAdapter(thursdayAdapter);
        EditText setsET = (EditText) findViewById(R.id.setsET_thursday);
        EditText repsET = (EditText) findViewById(R.id.repsET_thursday);
        EditText weightET = (EditText) findViewById(R.id.weightET_thursday);
        Button add = (Button)findViewById(R.id.thursday_add);
        // Activates method on yes button click
        add.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                thursdayExercises.add(exercise);
        ...
        thursdayLV.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                final int itemToDelete = i;
                // To delete the data from the App
                new AlertDialog.Builder(ThursdayExercisesActivity.this)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                thursdayExercises.remove(itemToDelete);
                                thursdayAdapter.notifyDataSetChanged();
                            }
    ...
    // Saves Thursday's exercises
    public void save(String id){
        SharedPreferences pref = getSharedPreferences(id+"thursday", MODE_PRIVATE);
        SharedPreferences.Editor editor = pref.edit();
        Gson gson = new Gson();
        String jsonSun = gson.toJson(thursdayExercises); // Converts array to json file
        editor.putString(id+"listThu", jsonSun); // Saves json file
        editor.apply();
    }

    // Loads Thursday's exercises
    public void load(String id){
        SharedPreferences pref = getSharedPreferences(id+"thursday", MODE_PRIVATE);
        Gson gson = new Gson();
        String json = pref.getString(id+"listThu", null); // Retrieves json file from storage
        ...
        else{thursdayExercises = gson.fromJson(json, type);}
    }
